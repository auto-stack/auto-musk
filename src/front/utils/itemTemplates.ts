// Plan 022 Phase 5b: 从 web/src/utils/itemTemplates.ts 复制，适配生成工程。
// 移除 @/types/specs 依赖（Status → string），生成工程无该类型路径。
...
export function getDefaultStatus(sectionType: string): string {
  switch (sectionType) {
