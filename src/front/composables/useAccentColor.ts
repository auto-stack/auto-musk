// useAccentColor.ts — 强调色切换 composable（Plan 022 视觉对齐，移植自原版 web/）
//
// 5 色色板：indigo / coral / ocean / sage / amber
// 运行时改 --primary + --vp-c-brand-* CSS 变量，持久化到 localStorage。
// codegen composable 机制：const accentColor = useAccentColor()。

import { readonly, ref, onMounted } from 'vue'

const STORAGE_KEY = 'musk-accent-color'
...
const PALETTES: Record<AccentName, AccentPalette> = {
  indigo: {
    ...
    brand1: '#6366f1', brand2: '#818cf8', brand3: '#4f46e5',
    brandSoft: 'rgba(99, 102, 241, 0.14)', primaryHsl: '239 84% 67%',
  },
  coral: {
    name: 'coral', label: 'Coral',
    brand1: '#e85d75', brand2: '#f08090', brand3: '#c9445e',
    brandSoft: 'rgba(232, 93, 117, 0.14)', primaryHsl: '350 75% 64%',
  },
  ocean: {
    name: 'ocean', label: 'Ocean',
    brand1: '#3b82f6', brand2: '#60a5fa', brand3: '#2563eb',
    brandSoft: 'rgba(59, 130, 246, 0.14)', primaryHsl: '217 91% 60%',
  },
  sage: {
    name: 'sage', label: 'Sage',
    brand1: '#10b981', brand2: '#34d399', brand3: '#059669',
    brandSoft: 'rgba(16, 185, 129, 0.14)', primaryHsl: '160 84% 39%',
  },
  amber: {
    name: 'amber', label: 'Amber',
    brand1: '#f59e0b', brand2: '#fbbf24', brand3: '#d97706',
    brandSoft: 'rgba(245, 158, 11, 0.14)', primaryHsl: '38 92% 50%',
  },
}
