...
fn parity_run_event_wire_and_event_type() {
    ...
    let hw_events = vec![
        ...
        hw::RunEvent::TurnToolResult { timestamp: 11, role_id: "r".into(), tool_id: "t".into(), result: "ok".into(), details: None },
    ...
    let ag_events = vec![
        ...
        ag::RunEvent::TurnToolResult { timestamp: 11, role_id: "r".into(), tool_id: "t".into(), result: "ok".into(), details: None },
